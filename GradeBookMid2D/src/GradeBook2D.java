...
public class GradeBook2D
{
   ...
   public double[] getColAverage()
   {
	      ...
	      for (int i = 0; i < grades.length; i++)
	      {
	    	  ...
	    	  {
	    		   colTotal[j] += grades[i][j];
	    	  }
	      }
	      
	      for (int count=0 ; count<3; count++)
	    	  colAvg[count] = (double)colTotal[count]/grades.length;
   ...
   public void outputGrades()
   {
      ...
      for (double grade : eachTestAvg)
    	  System.out.printf("%8.2f", grade);
   } 
} // end class GradeBook